---
'@guideflow/banner': minor
'@guideflow/core': patch
'@guideflow/checklist': patch
---

New package `@guideflow/banner` — a docked, non-blocking announcement surface
...
keyboard trap under WCAG 2.1.2. Announcements go through a *separate*
